...
//            $nbr_people = intval($enfants[$j]["nombre"]);
    ...
    public function rechercheByLieuAction(Request $request)
    {
        ...
        if($request->isMethod("POST"))
        {
            ...
            $enfant = $em->getRepository('EnfantsBundle:Enfants')->findBy(array('lieuNaissance'=>$lieu));
    ...
    public function rechercheByMedicinAction(Request $request)
    {
        ...
        if($request->isMethod("POST"))
        {
            ...
            $enfant = $em->getRepository('EnfantsBundle:Enfants')->findBy(array('medicin'=>$medicin),array('medecinNumero'=>'DESC'));
